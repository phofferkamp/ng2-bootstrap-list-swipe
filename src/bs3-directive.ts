...
@Directive({
  selector: '[bs3-list-swipe-item]'
})
export class Bs3SwipeDirective {
  ...
  ngOnInit() {
    ...
    this.renderer.addClass(this.deleteContainer, "bs3DeleteContainer");
    ...
    this.renderer.listen(this.el.nativeElement, "swipeleft", () => {
      ...
      this.renderer.addClass(this.el.nativeElement, "bs3ItemEditMode");
      this.renderer.removeClass(this.el.nativeElement, "bs3ItemUneditMode");
      this.renderer.addClass(this.deleteContainer, "bs3DeleteEditMode");
      this.renderer.removeClass(this.deleteContainer, "bs3DeleteUneditMode");
    });
  ...
  uneditItem() {
    if (this.el.nativeElement.className.indexOf("bs3ItemEditMode") > -1) {
      this.renderer.addClass(this.el.nativeElement, "bs3ItemUneditMode");
      this.renderer.removeClass(this.el.nativeElement, "bs3ItemEditMode");
    }
    if (this.deleteContainer.className.indexOf("bs3DeleteEditMode") > -1) {
      this.renderer.addClass(this.deleteContainer, "bs3DeleteUneditMode");
      this.renderer.removeClass(this.deleteContainer, "bs3DeleteEditMode");
    }
  }
